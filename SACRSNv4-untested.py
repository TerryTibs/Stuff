...
CONFIG = {
    ...
    "n_symbols": 64,          # Matches vocab size (prevents diluted graph)
...
# ==========================================
# 6. Ultimate Training Engine (Scheduler + Entropy)
# ==========================================
def train():
    ...
    print(f"--- Training Ultimate CRSN ---")
    print(f"--- Features: Graph Bias | ACT | Entropy Reg | Scheduler ---")
    ...
    try:
        for epoch in range(CONFIG["epochs"]):
            ...
            # [UPGRADE] Entropy Weight Decay: Encourage exploration early
            ...
            for i in range(0, len(data_tensor) - 1):
                ...
                # [UPGRADE] Entropy Loss (Prevents Dead Symbols)
...
def extract_logic_rules(model, data_tensor):
    print("\n--- Extracting Explicit Logic Rules (Diagnostics) ---")
    model.eval()
